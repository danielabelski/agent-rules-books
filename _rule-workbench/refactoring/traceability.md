...
- Dropped from `nano.md` as secondary: detailed smell taxonomy and some movement-specific nomenclature.
...
- `M2` Use small, verifiable steps; reject big-bang rewrites and mixed-intent patches. Source: `Non-Negotiable Rules` (53-78), `Forbidden Patterns / Big-Bang Rewrite` (266-270), `Forbidden Patterns / Mixed-Intent Patches` (271-275).
...
- `M4` Refactor toward the smell that blocks change now: duplication, long functions, hidden dependencies, shotgun surgery, primitive obsession, conditionals, speculative generality. Source: `Code Smell Policy` (104-157).
- `M5` Prefer known moves such as rename, extract, move, inline, simplify, split phase, and data-shape improvements over improvised structural leaps. Source: `Preferred Refactoring Moves` (158-190), `Function-Level Rules` (191-202), `Class and Module Rules` (203-213).
- `M6` Stop when the requested change is safe and clear; do not refactor theatrically or abstract too early. Source: `Stopping Rules` (332-342), `Forbidden Patterns / Abstracting Too Early` (276-280), `Forbidden Patterns / Refactoring Theater` (281-285).

## Nano mapping

- `N1` Refactoring preserves observable behavior. Source: `What Counts as Refactoring` (35-52).
- `N2` Use small, verifiable steps; no big-bang rewrites. Source: `Non-Negotiable Rules` (53-78), `Forbidden Patterns / Big-Bang Rewrite` (266-270).
